...
def register_dataset_to_detectron(instance_name: str,img_dir_path: str, ann_path: str):
    ...
    MetadataCatalog.get(instance_name).thing_classes = ['garbage']
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg, aug_settings_file_path: str=None):
        aug_settings_file_path = 'test_handler.json'
...
if __name__ == "__main__":
    ...
    instance_name = "garbage"
    dest_folder_img_combined = "/home/pasonatech/combined_cocooutput/5_21_coco_real/"
    dest_json_file_combined = "/home/pasonatech/combined_cocooutput/5_21_coco_real/HSR-coco.json"
